...
Métricas reportadas (gracias a la arquitectura 2-bloques del fitness):
    valor          = alpha·f_factibilidad + (1-alpha)·f_rendimiento  in [0, 1]
    f_factibilidad = restricciones violadas (Tello §6.3.3)    in [0, 1]
    f_rendimiento  = 4 objetivos Tello (cobertura como aux)   in [0, 1]
